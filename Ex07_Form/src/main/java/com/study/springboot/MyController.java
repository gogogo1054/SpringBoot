...
public class MyController
{
	...
	/*
		커맨드 객체를 통해 파라미터를 한꺼번에 받아 저장하고, Model객체에
		저장까지 해준다. 파라미터를 저장한 DTO를 통해 출력해야 하므로
		View에서는 getter를 사용한다.
	*/
	@RequestMapping("/test3")	//	localhost:8081/test2
	...
	/*
		...
		경로설정에 유의해야한다.
	*/
	//	패스자체에 변수를 넣어 줄 수도 있다.
	@RequestMapping("/test4/{studentId}/{name}")	//	localhost:8081/test2
